...
plot(pp1$DateTimeObj,pp1$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab=" ")
...
plot(pp1$DateTimeObj,pp1$Global_reactive_power, type="l", xlab="DateTime", ylab="Global Reactive Power (kilowatts)")
